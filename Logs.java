...
public class Logs extends javax.swing.JFrame {
       ...
       public String[] setproduct(String[] product) {
          this.product = product; // I slightly tweaked this so it actually saves your data!
          return product;
       }
       ...
       public final void input() {
        ...
        model.addRow(new Object[]{counter, product[0], Qty[0], total[0]});

        for (int i = 1; i < product.length; i++) {

            model.addRow(new Object[]{null, product[i], Qty[i], total[i]});
        }
    ...
    private void initComponents() {
        ...
        jPanel5.setPreferredSize(new java.awt.Dimension(563, 700));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        MainClass.frame3.setVisible(true);
